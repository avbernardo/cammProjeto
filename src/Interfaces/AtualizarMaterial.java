...
import camm.JtextFielSomenteNumerosLetr;
...
public class AtualizarMaterial extends javax.swing.JFrame {
    ...
    public AtualizarMaterial() {
        ...
        //DefaultTableModel modelo = (DefaultTableModel) jTMateriales.getModel();
       // jTMateriales.setRowSorter(new TableRowSorter(modelo));
   ...
   /* public void readJTable() {
        ...
        for (Material f : csql.selectAllMaterial()) {
   ...
   /* public void readJTableForDesc(String nome) {
        ...
        for (Material f : csql.selectForMaterial(nome)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        Nome = new JtextFielSomenteNumerosLetr(50);
        jLabel1 = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        preço = new JtextFielSomenteNumeros(13);
        ...
        Nome.setToolTipText("Nome do material");
        ...
        jLabel2.setText("Preço por Quilo / Unidade (R$)");

        preço.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        preço.setToolTipText("Preço por quilo ou unidade do material");
        ...
        jLabel4.setText("Comprado / Vendido por");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(Nome, javax.swing.GroupLayout.PREFERRED_SIZE, 545, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(preço, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
public void atualiza(Material c){
    
    Nome.setText(c.getNome());
    preço.setText(Double.toString(c.getPreço_Kilo_Unidade()));
    
    codigo = c.getCod_Material();
...
//Se o usuário clicar em "Sim" retorna 0 pra variavel reply, se informado não retorna 1
     ...
     if (reply == JOptionPane.YES_OPTION)
     {
        ...
        if(Nome.getText().equals("") || preço.getText().equals("") || !(jRadioButton2.isSelected() || jRadioButton1.isSelected() )){
            if(Nome.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Nome não pode ser nulo ");
            }
            if(preço.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Preço não pode ser nulo ");
            }
            if(!(jRadioButton2.isSelected() || jRadioButton1.isSelected() )){
              JOptionPane.showMessageDialog(null, "Selecione Peso ou Unidade");  
            }
        }
        else{
        f.setNome(Nome.getText());
        f.setPreço_Kilo_Unidade(Double.parseDouble(preço.getText()));
        f.setCod_Material(codigo);
        if(jRadioButton2.isSelected()){
        f.setPorQuantidade(false);
         }else{
           f.setPorQuantidade(true);
        }
        
         
       
        csql.updateMaterial(f);
        
        ConsultaMaterial cc = new ConsultaMaterial();
        cc.setVisible(true);
...
//        DefaultTableModel dtmProdutos = (DefaultTableModel) jTMaterials.getModel();
...
//        dtmProdutos.addRow(dados);
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        // TODO add your handling code here:
        jLabel2.setText("Preço por Quilo (R$)");
    }//GEN-LAST:event_jRadioButton2ActionPerformed

    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        // TODO add your handling code here:
        jLabel2.setText("Preço por Unidade (R$)");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tela onde é possível atualizar/modificar os dados de algum material que já está dentro do sistema.\n" +
"Basta clicar nos respectivos campos e digitar os dados que se pede, ao finalizar clique em “Atualizar”.\nCaso contrário clique em “Cancelar” para sair da tela Atualizar Material.","Ajuda",3,null);
