...
import static Interfaces.ManterUsuário.confirmação;
...
public class AtualizarUsuário extends javax.swing.JFrame {
     ...
     */
    public AtualizarUsuário() {
        this.setResizable(false);
        initComponents();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        
        //DefaultTableModel modelo = (DefaultTableModel) jTUsuárioes.getModel();
       // jTUsuárioes.setRowSorter(new TableRowSorter(modelo));
   ...
   /* public void readJTable() {
        ...
        for (Usuário f : csql.selectAllUsuário()) {
   ...
   /* public void readJTableForDesc(String nome) {
        ...
        for (Usuário f : csql.selectForUsuário(nome)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel6.setPreferredSize(new java.awt.Dimension(466, 65));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/help.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/arrow_rotate_clockwise.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(respEspecial, javax.swing.GroupLayout.PREFERRED_SIZE, 465, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(login)
                            .addComponent(senha)
                            .addComponent(senhaconfirm, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
...
public void atualiza(Usuário c){
     ...
     if (reply == JOptionPane.YES_OPTION)
     {
        ...
        if(login.getText().equals("") || senha.getText().equals("") || comboPergunta.getSelectedIndex() == 0 || respEspecial.getText().equals("")){
            ...
            if(senha.getText().equals(senhaconfirm.getText())){
                ...
                try {
                    csql.updateUsuário(c);
                    Login l = new Login();
                    l.setVisible(true);
                    this.dispose();
                } catch (NoSuchAlgorithmException ex) {
                    Logger.getLogger(AtualizarUsuário.class.getName()).log(Level.SEVERE, null, ex);
...
//        dtmProdutos.addRow(dados);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("ARIAL", Font.PLAIN, 16)));
        ...
        JOptionPane.showMessageDialog(null, "Tela onde é possível atualizar/modificar os dados de algum usuário que já está dentro do sistema.\n" +
"Basta clicar nos respectivos campos e digitar os dados que se pede, ao finalizar clique em “Atualizar”.\nCaso contrário clique em “Cancelar” para sair da tela Atualizar Usuário.","Ajuda",3,null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarUsuário.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarUsuário().setVisible(true);
