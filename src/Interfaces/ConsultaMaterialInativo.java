...
public class ConsultaMaterialInativo extends javax.swing.JFrame {
    ...
    public ConsultaMaterialInativo() {
    ...
    public void readJTable() {
        ...
        String unidade;
        for (Material c : csql.selectAllMaterialInativo()) {
    ...
    public void readJTableForDesc(String nome) {
        ...
        for (Material c : csql.selectForMaterialInativo(nome)) {
...
//        System.out.println("Linha selecionada: "+jTMaterials.getSelectedRow());
        if (jTMateriais.getSelectedRow() != -1) {
         ...
         JOptionPane.getRootFrame().dispose();
            ...
            JOptionPane.showMessageDialog(null, "Selecione um material para reativar.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaMaterialInativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaMaterialInativo().setVisible(true);
