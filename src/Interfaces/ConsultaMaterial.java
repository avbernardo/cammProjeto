...
public class ConsultaMaterial extends javax.swing.JFrame {
    ...
    public ConsultaMaterial() {
        ...
        DefaultTableModel modelo = (DefaultTableModel) jTMateriais.getModel();
        jTMateriais.setRowSorter(new TableRowSorter(modelo));
        jTMateriais.setDefaultRenderer(Object.class, new Centraliza());
        ...
        jTMateriais.getColumnModel().getColumn(2).setCellRenderer(direita);
        jTMateriais.getColumnModel().getColumn(0).setCellRenderer(direita);
    ...
    public void readJTable() {
        ...
        DefaultTableModel modelo = (DefaultTableModel) jTMateriais.getModel();
        modelo.setNumRows(0);
        MaterialSQL csql = new MaterialSQL();
        String unidade;
        for (Material c : csql.selectAllMaterial()) {
            if(c.isPorQuantidade()){
               unidade = "Unidades";
            }else{
                unidade = "Kg";
            }
            modelo.addRow(new Object[]{
                c.getCod_Material(),
                c.getNome(),
                df.format(c.getPreço_Kilo_Unidade()),
                unidade
    ...
    public void readJTableForDesc(String nome) {
        ...
        MaterialSQL csql = new MaterialSQL();
        String unidade;
        for (Material c : csql.selectForMaterial(nome)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione um material para alterar ou inativar");

        jTMateriais.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTMateriais.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Nome", "Preço Quilo / Unidade (R$)", "Unidade de medida"
            }
        ) {
        ...
        jTMateriais.setRowHeight(25);
        jTMateriais.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTMateriaisMouseClicked(evt);
            }
        });
        jTMateriais.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTMateriaisKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jTMateriais);
        if (jTMateriais.getColumnModel().getColumnCount() > 0) {
            jTMateriais.getColumnModel().getColumn(0).setMinWidth(35);
            jTMateriais.getColumnModel().getColumn(0).setPreferredWidth(35);
            jTMateriais.getColumnModel().getColumn(0).setMaxWidth(35);
        }

        jButton1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/zoom_out.png"))); // NOI18N
        ...
        jLabel2.setText("CONSULTAR MATERIAL");
...
//        System.out.println("Linha selecionada: "+jTMaterials.getSelectedRow());
        if (jTMateriais.getSelectedRow() != -1) {

            Material c = new Material();
            MaterialSQL csql = new MaterialSQL();

            c.setCod_Material((int) jTMateriais.getValueAt(jTMateriais.getSelectedRow(), 0));
    ...
    private void jTMateriaisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTMateriaisMouseClicked
        // TODO add your handling code here:

        

    }//GEN-LAST:event_jTMateriaisMouseClicked

    private void jTMateriaisKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTMateriaisKeyReleased
        // TODO add your handling code here:

        

    }//GEN-LAST:event_jTMateriaisKeyReleased
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jTMateriais.getSelectedRow() != -1) {
            ...
            try {
                ...
                c.setCod_Material((int) jTMateriais.getValueAt(jTMateriais.getSelectedRow(), 0));
                c.setNome((String) jTMateriais.getValueAt(jTMateriais.getSelectedRow(), 1));
                String valor = (String) jTMateriais.getValueAt(jTMateriais.getSelectedRow(), 2);
                NumberFormat format = NumberFormat.getInstance(Locale.US);
                Number number = format.parse(valor);
                double d = number.doubleValue();
                c.setPreço_Kilo_Unidade(d);
                
                
                
                AtualizarMaterial a = new AtualizarMaterial();
                a.setVisible(true);
                a.atualiza(c);
                
                this.dispose();
                //csql.updateMaterial(c);
                
                
                
                readJTable();
            } catch (ParseException ex) {
                Logger.getLogger(ConsultaMaterial.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Tela para consultar os materiais disponíveis para compra e/ou venda dentro do sistema.\nPara alterar ou excluir um material, basta selecioná-lo e clicar em “Alterar” ou “Excluir”.","Ajuda",3,null);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ConsultaMaterialInativo m = new ConsultaMaterialInativo();
        m.setVisible(true);
        this.dispose();
