...
public class ConsultaCliente extends javax.swing.JFrame {
    ...
    public void readJTable() {
        ...
        for (Cliente c : csql.selectAllCliente()) {
    ...
    public void readJTableForDesc(String nome) {
        ...
        for (Cliente c : csql.selectForCliente(nome)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Selecione um cliente para alterar ou inativar ");
...
//        System.out.println("Linha selecionada: "+jTClientes.getSelectedRow());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        c.setID_Cliente((int) jTClientes.getValueAt(jTClientes.getSelectedRow(), 0));
        c.setNome((String) jTClientes.getValueAt(jTClientes.getSelectedRow(), 1));
        c.setContato((String) jTClientes.getValueAt(jTClientes.getSelectedRow(), 2));
        c.setBairro((String) jTClientes.getValueAt(jTClientes.getSelectedRow(), 4));
        c.setCidade((String) jTClientes.getValueAt(jTClientes.getSelectedRow(), 3));
        c.setLogradouro((String) jTClientes.getValueAt(jTClientes.getSelectedRow(), 5));
        c.setNúmero((String) jTClientes.getValueAt(jTClientes.getSelectedRow(), 6));
        AtualizarCliente a = new AtualizarCliente();
        a.setVisible(true);
        a.atualiza(c);
       
        this.dispose();
        //csql.updateCliente(c);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tela para consultar todos os clientes que estão ativos dentro do sistema.\nPara alterar ou inativar um cliente, basta selecioná-lo e clicar em “Alterar” ou “Inativar”.\nPara consultar os cliente inativos clique em “Ver inativos”.\nÉ possível fazer uma busca utilizando o campo Buscar.","Ajuda",3,null);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ConsultaClienteInativo c = new ConsultaClienteInativo();
        c.setVisible(true);
        this.dispose();
