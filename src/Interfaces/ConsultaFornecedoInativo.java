...
public class ConsultaFornecedoInativo extends javax.swing.JFrame {
    ...
    public ConsultaFornecedoInativo() {
    ...
    public void readJTable() {
        ...
        for (Fornecedor c : csql.selectAllFornecedorInativo()) {
    ...
    public void readJTableForDesc(String nome) {
        ...
        for (Fornecedor c : csql.selectForFornecedorInativo(nome)) {
...
//        System.out.println("Linha selecionada: "+jTFornecedors.getSelectedRow());
        if (jTFornecedores.getSelectedRow() != -1) {
            ...
            csql.updateReativaFornecedor(c);
             }
             else{
         JOptionPane.getRootFrame().dispose();
            ...
            JOptionPane.showMessageDialog(null, "Selecione um fornecedor para reativar.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaFornecedoInativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaFornecedoInativo().setVisible(true);
