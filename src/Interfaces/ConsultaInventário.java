...
public class ConsultaInventário extends javax.swing.JFrame {
    ...
    int codigo;
    public ConsultaInventário() throws ParseException {
    ...
    public void readJTable() throws ParseException {
        ...
        DefaultTableModel modelo = (DefaultTableModel) jTCompras.getModel();
        modelo.setNumRows(0);
        InventárioSQL csql = new InventárioSQL();
        String formatado;
       ...
       // String formattedDate = new SimpleDateFormat("dd/MM/yyyy, Ka").format(date);
        for (Inventário c : csql.selectAllInventário()) {
            java.util.Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(c.getDataMovimentação());
    ...
    public void readJTableForDesc(String nome) throws ParseException {
        ...
        DecimalFormat df = new DecimalFormat("##,##0.000 Kg");
        DecimalFormat df1 = new DecimalFormat("##,##0 Unidades");
        for (Inventário c : csql.selectForInventário(nome)) {
            java.util.Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(c.getDataMovimentação());
            String dataFormatada = new SimpleDateFormat("dd/MM/yyyy, HH:mm").format(date);
            if(c.getMaterial().isPorQuantidade()){
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Data", "Material", "Peso / Quantidade", "Tipo Movimentação"
            }
        ) {
        ...
        jLabel2.setText("CONSULTAR INVENTÁRIO");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(buscaNome.getText().equals("")){
            try {
                ...
                Logger.getLogger(ConsultaInventário.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        else
        try {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tela onde é possível ver detalhes dos materiais inventariados dentro do sistema,\ntambém pode-se buscar um material por nome ou data usando o campo de busca.","Ajuda",3,null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaInventário.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ConsultaInventário().setVisible(true);
                } catch (ParseException ex) {
                    Logger.getLogger(ConsultaInventário.class.getName()).log(Level.SEVERE, null, ex);
                }
