...
public class ConsultaRelatório extends javax.swing.JFrame {
    ...
    int codigo;
    public ConsultaRelatório() throws ParseException {
        ...
        jTCompras.getColumnModel().getColumn(4).setCellRenderer(direita);
    ...
    public void readJTable() throws ParseException {
        ...
        DefaultTableModel modelo = (DefaultTableModel) jTCompras.getModel();
        modelo.setNumRows(0);
        RelatórioSQL csql = new RelatórioSQL();
        //java.util.Date date = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parse("c");
       // String formattedDate = new SimpleDateFormat("dd/MM/yyyy, Ka").format(date);
        for (Relatório c : csql.selectAllRelatório()) {
            java.util.Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(c.getDataRelatório());
            String dataFormatada = new SimpleDateFormat("dd/MM/yyyy, HH:mm").format(date);
            modelo.addRow(new Object[]{
                c.getCod_Relatório(),
                dataFormatada,
                df.format(c.getTotalCompras()),
                df.format(c.getTotalVendas()),
                df.format(c.getLucro()),
                c.getTipoRelatório()
            });
    ...
    public void readJTableForDesc(String nome) throws ParseException {
        
        DefaultTableModel modelo = (DefaultTableModel) jTCompras.getModel();
        modelo.setNumRows(0);
        RelatórioSQL csql = new RelatórioSQL();

        for (Relatório c : csql.selectForRelatório(nome)) {
            modelo.addRow(new Object[]{
                c.getCod_Relatório(),
                c.getDataRelatório(),
                df.format(c.getTotalCompras()),
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Data", "Total Compras (R$)", "Total Vendas (R$)", "Resultado (R$)", "Tipo"
            }
        ) {
        ...
        jLabel2.setText("CONSULTAR RELATÓRIO");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(buscaNome.getText().equals("")){
            try {
                ...
                Logger.getLogger(ConsultaRelatório.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        else
        try {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tela onde é possível ver detalhes dos relatórios que estão dentro do sistema,\ntambém pode-se buscar um relatório usando o campo de busca.","Ajuda",3,null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaRelatório.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ConsultaRelatório().setVisible(true);
                } catch (ParseException ex) {
                    Logger.getLogger(ConsultaRelatório.class.getName()).log(Level.SEVERE, null, ex);
                }
