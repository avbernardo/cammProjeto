...
public class ConsultaCompra extends javax.swing.JFrame {
    ...
    int codigo;
    public ConsultaCompra() throws ParseException {
        ...
        jTCompras.setRowSorter(new TableRowSorter(modelo));
        ...
        jTCompras.getColumnModel().getColumn(3).setCellRenderer(direita);
    ...
    public void readJTable() throws ParseException {
       ...
       // String formattedDate = new SimpleDateFormat("dd/MM/yyyy, Ka").format(date);
        for (Compra c : csql.selectAllCompra()) {
     ...
     public void readJTableForData(java.util.Date data1,java.util.Date data2) throws ParseException {
        ...
        //java.util.Date date = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parse("c");
       // String formattedDate = new SimpleDateFormat("dd/MM/yyyy, Ka").format(date);
        for (Compra c : csql.selectForCompraData(data1, data2)) {
           // java.util.Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(c.getData());
            //String dataFormatada = new SimpleDateFormat("dd/MM/yyyy, HH:mm").format(date);
            modelo.addRow(new Object[]{
                c.getCod_Compra(),
    ...
    public void readJTableT(int codigo) {
        ...
        DecimalFormat df = new DecimalFormat("#,###.00"); 
        jTItens.setDefaultRenderer(Object.class, new Centraliza());
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
    ...
    public void readJTableForDesc(String nome,java.util.Date data1,java.util.Date data2) throws ParseException {
        ...
        for (Compra c : csql.selectForCompra(nome,data1,data2)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fornecedor", "Data", "Valor Total (R$)"
            }
        ) {
        ...
        jTCompras.setIntercellSpacing(new java.awt.Dimension(1, 2));
        jTCompras.setRowHeight(25);
        ...
        if (jTCompras.getColumnModel().getColumnCount() > 0) {
            jTCompras.getColumnModel().getColumn(0).setMinWidth(35);
            jTCompras.getColumnModel().getColumn(0).setPreferredWidth(35);
            jTCompras.getColumnModel().getColumn(0).setMaxWidth(35);
        }
        ...
        jLabel2.setText("CONSULTAR COMPRA");
    ...
    private void jTComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTComprasMouseClicked
        ...
        if (jTCompras.getSelectedRow() != -1) {
            ...
            codigo = (int) jTCompras.getValueAt(jTCompras.getSelectedRow(),0);
