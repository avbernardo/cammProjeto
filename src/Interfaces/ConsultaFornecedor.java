...
public class ConsultaFornecedor extends javax.swing.JFrame {
    ...
    public ConsultaFornecedor() {
        ...
        jTFornecedores.getColumnModel().getColumn(5).setCellRenderer(direita);
    ...
    public void readJTable() {
        ...
        for (Fornecedor c : csql.selectAllFornecedor()) {
    ...
    public void readJTableForDesc(String nome) {
        ...
        for (Fornecedor c : csql.selectForFornecedor(nome)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione um fornecedor para alterar ou inativar ");
        ...
        jTFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Contato", "Bairro", "Logradouro", "Número"
            }
        ) {
        ...
        jTFornecedores.setIntercellSpacing(new java.awt.Dimension(1, 2));
        ...
        if (jTFornecedores.getColumnModel().getColumnCount() > 0) {
            jTFornecedores.getColumnModel().getColumn(0).setMinWidth(35);
            jTFornecedores.getColumnModel().getColumn(0).setPreferredWidth(35);
            jTFornecedores.getColumnModel().getColumn(0).setMaxWidth(35);
        }
...
//        System.out.println("Linha selecionada: "+jTFornecedors.getSelectedRow());
        if (jTFornecedores.getSelectedRow() != -1) {

            Fornecedor c = new Fornecedor();
            FornecedorSQL csql = new FornecedorSQL();

            c.setID_Fornecedor((int) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 0));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        c.setID_Fornecedor((int) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 0));
        c.setNome((String) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 1));
        c.setContato((String) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 2));
        c.setBairro((String) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 3));
        c.setLogradouro((String) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 4));
        c.setNúmero((String) jTFornecedores.getValueAt(jTFornecedores.getSelectedRow(), 5));
        AtualizarFornecedor a = new AtualizarFornecedor();
        a.setVisible(true);
        a.atualiza(c);
       
        this.dispose();
        //csql.updateFornecedor(c);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tela onde é possível ver detalhes dos fornecedores que estão dentro do sistema,\nPara alterar ou excluir um fornecedor, basta selecioná-lo e clicar em “Alterar” ou “Excluir”.","Ajuda",3,null);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ConsultaFornecedoInativo f = new ConsultaFornecedoInativo();
        f.setVisible(true);
        this.dispose();
