...
public class AtualizarFornecedor extends javax.swing.JFrame {
   ...
   /* public void readJTable() {
        ...
        for (Fornecedor f : csql.selectAllFornecedor()) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel7.setText("ATUALIZAR FORNECEDOR ");
        jLabel7.setPreferredSize(new java.awt.Dimension(605, 65));
        ...
        Nome.setToolTipText("Nome do fornecedor");
        ...
        Bairro.setToolTipText("Bairro onde reside o fornecedor");
        ...
        Logradouro.setToolTipText("Logradouro onde reside o fornecedor");
        ...
        Contato.setToolTipText("Telefone para contato com o fornecedor");
        ...
        Número.setToolTipText("Número de onde reside o fornecedor");
...
//Se o usuário clicar em "Sim" retorna 0 pra variavel reply, se informado não retorna 1
     ...
     if (reply == JOptionPane.YES_OPTION)
     {
        ...
        csql.updateFornecedor(f);
      
        
        ConsultaFornecedor cc = new ConsultaFornecedor();
        cc.setVisible(true);
...
//        dtmProdutos.addRow(dados);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tela onde é possível atualizar/modificar os dados de algum fornecedor que já está dentro do sistema.\n" +
"Basta clicar nos respectivos campos e digitar os dados que se pede, ao finalizar clique em “Atualizar”.\nCaso contrário clique em “Cancelar” para sair da tela Atualizar Fornecedor.","ajuda",3,null);
