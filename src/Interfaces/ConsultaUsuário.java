...
public class ConsultaUsuário extends javax.swing.JFrame {
    ...
    public ConsultaUsuário() {
        
        initComponents();
        this.setResizable(false);
        DefaultTableModel modelo = (DefaultTableModel) jTUsuários.getModel();
        jTUsuários.setRowSorter(new TableRowSorter(modelo));
        jTUsuários.setDefaultRenderer(Object.class, new Centraliza());
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();

        
        direita.setHorizontalAlignment(SwingConstants.RIGHT);
        
        jTUsuários.getColumnModel().getColumn(0).setCellRenderer(direita);
        jTUsuários.getColumnModel().getColumn(1).setCellRenderer(direita);
    ...
    public void readJTable() {
        ...
        for (Usuário c : csql.selectAllUsuário()) {
    ...
    public void readJTableForDesc(String nome) {
        ...
        for (Usuário c : csql.selectForUsuário(nome)) {
  ...
  //  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTUsuários = new javax.swing.JTable();
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/arrow_branch.png"))); // NOI18N
        ...
        jLabel1.setText("Selecione um usuário para alterar ou excluir");

        jTUsuários.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTUsuários.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTUsuários.setRowHeight(25);
        jTUsuários.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTUsuáriosMouseClicked(evt);
            }
        });
        jTUsuários.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTUsuáriosKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(jTUsuários);
        if (jTUsuários.getColumnModel().getColumnCount() > 0) {
            jTUsuários.getColumnModel().getColumn(0).setMinWidth(50);
            jTUsuários.getColumnModel().getColumn(0).setPreferredWidth(50);
            jTUsuários.getColumnModel().getColumn(0).setMaxWidth(50);
        }
...
//        System.out.println("Linha selecionada: "+jTUsuários.getSelectedRow());
        if (jTUsuários.getSelectedRow() != -1) {

            Usuário c = new Usuário();
            UsuárioSQL csql = new UsuárioSQL();

            c.setCod_Usuário((int) jTUsuários.getValueAt(jTUsuários.getSelectedRow(), 0));
            c.setLogin((String) jTUsuários.getValueAt(jTUsuários.getSelectedRow(), 1));
             ...
             if (reply == JOptionPane.YES_OPTION){
                try {
                    if(c.getCod_Usuário()==1){
                     JOptionPane.showMessageDialog(null, "O usuário Admin não pode ser excluído");
                     return;
                    }
                    ...
                    JOptionPane.showMessageDialog(null, entUsuario, "Confirmação de senha", JOptionPane.PLAIN_MESSAGE);
                    String senha = password.getText();
                    
                    boolean check = csql.checkLogin(c.getLogin(), senha);
                    if(check){
                        
                        csql.deleteUsuário(c);
                    }
                    else{
                        JOptionPane.showMessageDialog(null, "Senha incorreta");
                    }   } catch (NoSuchAlgorithmException ex) {
                    Logger.getLogger(ConsultaUsuário.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jTUsuáriosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTUsuáriosMouseClicked
        // TODO add your handling code here:

        

    }//GEN-LAST:event_jTUsuáriosMouseClicked

    private void jTUsuáriosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTUsuáriosKeyReleased
        // TODO add your handling code here:

        

    }//GEN-LAST:event_jTUsuáriosKeyReleased
             ...
             if (reply == JOptionPane.YES_OPTION){
                try {
                    ...
                    if(check){
                        ...
                        AtualizarUsuário a = new AtualizarUsuário();
                        a.setVisible(true);
                        a.atualiza(c);
                        this.dispose();
                    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Tela para consultar todos os usuários que estão dentro e tem acesso do sistema.\nSe desejar alterar algum usuário basta selecionar um, clicar em “Alterar” e informar a senha do usuário.\nSe desejar excluir algum usuário basta selecionar um, clicar em “Excluir” e informar a senha do usuário.","Ajuda",3,null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaUsuário.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaUsuário().setVisible(true);
    ...
    private javax.swing.JTable jTUsuários;
