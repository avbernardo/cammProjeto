...
public JtextFielSomenteNumerosInteiros(int maximo) {    
    super();
...
String caracteres="abcdefghijklmnopqrstuvwxyz,/!@#$%¨&*()_><][+{}^`¹²³£-¢¬ç|?~'\';. ";// lista de caracters que não devem ser aceitos
